...
<div class="w3-row w3-padding-64" id="about">
    <?php foreach ($resultPopular as $result) : ?>
        <div class="w3-col m6 w3-padding-large w3-hide-small">
            <img src="<?= $result['image_url'] ?>" class="w3-round w3-image w3-opacity-min" alt="<?= $result['image_name'] ?>" width="600" height="750">
        </div>

        <div class="w3-col m6 w3-padding-large">
            <h1 class="w3-center">Service</h1><br>
            ...
            <div> <a href="<?php echo ROOT_URL . '/Product/show&id=' . $result['id'] ?>" class="btn btn-success">View more </a></div>
        </div>
        <?php break; ?>
    <?php endforeach; ?>
</div>
...
<div class="w3-row w3-padding-64" id="menu">
    <div class="w3-col w3-padding-large">
        <h1 class="w3-center">Popular</h1><br>
    </div>
    <?php foreach (array_slice($resultPopular, 1, 2) as $result) : ?>
        ...
        <div class="w3-col l6 w3-padding-large">
            <img src="<?= $result['image_url'] ?>" class="w3-round w3-image w3-opacity-min" alt="Menu" style="width:100%">
        </div>
    <?php endforeach; ?>
</div>
