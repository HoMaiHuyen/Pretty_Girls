...
<body>
    <header class="head" id="myTopnav">
        ...
        <?php if(isset($_GET['qty'])) :{ ?>
            <div class="item1">
                ...
                <a href="<?php echo ROOT_URL .'/user/shoppingCart'?>"><span id="cartQty"><?php echo $_GET['qty'] ?></span><i data-qty="<?php echo $_GET['qty'] ?>" class="fa-solid fa-cart-shopping"></i>
    </i></a>
            </div>
    ...
    <?php }else : ?>
            <div class="item1">
                ...
                <a href="<?php echo ROOT_URL .'/user/shoppingCart'?>"><i data-bs-toggle="" class="fa-solid fa-cart-shopping"></i></a>
            </div>
            <a class="dropdown" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                <?php isset($_SESSION['user_id']) ?>
                <a class="dropdown" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
