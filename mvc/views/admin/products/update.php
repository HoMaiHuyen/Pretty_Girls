...
<div id="layoutSidenav_content">
    ...
    <?php 
        ...
        <div class="container">
            <form action="<?php echo ROOT_URL . '/AdminProduct/updateProduct1' ?>" method="post" enctype="multipart/form-data">
            <div class="mb-3 mt-3">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="file" class="form-control" id="PImage_url" placeholder="Enter Image URL " name="PImage_url" value="<?php echo $productOne['image_url'] ?>" >
