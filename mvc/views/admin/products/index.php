                             ...
                             <?php
                                ...
                                ?>
                                 <tr>
                                     ...
                                     <th><a href="<?php echo ROOT_URL . '/admin/deleteProduct&id=' . $product['id'] ?>"><i class='fa-solid fa-trash'></i>Delete</th>
                                     <th><a href="<?php echo ROOT_URL . '/admin/updateProduct&id=' . $product['id'] ?>"><i class="fa fa-pencil-square" aria-hidden="true" name=""></i>Update</th>
                                 </tr>
