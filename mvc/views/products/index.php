...
<section>
    <div class="container">
        <div class="row">
            <h2 style='color:var(--blue-color);'>FACE</h2>
            <?php
                    ...
                    <div class="col-sm-4" style="padding-bottom: 20px;">
                        <div class="card card-product">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-light btn-light-buynow"><a href="#!" style="text-decoration: none;color:black;color: var(--blue-color);">Buy Now</a></button>
                            </div>
                        </div>
                    </div>
            <?php } else {
                    ...
                    <div class="col-sm-4" style="padding-bottom: 20px;  ">
                        <div class="card card-product">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <button type="button" class="btn btn-light btn-light-addtocart">Add To Cart</button>
                                <button type="button" class="btn btn-light btn-light-buynow"><a href="#!" style="text-decoration: none;color: var(--blue-color);">Buy Now</a></button>
